...
import "./Landing.css";
import logo from '../../assets/eventimage/logop.png'
...
const Landing = () => {
 ...
 <div className="land-cont">
  <img src={logo} alt="logo" className="logo" />
      ...
      <div className="btn-rul"><a href="" target ="_blank" download className=" rulebtn"><button className="btn-grad">Brouchure</button></a></div>
    </div>
